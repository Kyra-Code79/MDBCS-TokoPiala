                            ...
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                <div class="card-header border-0">
                                    <div class="card-title text-center">
                                        <img src="../../../app-assets/images/ico/TRPL.png" alt="branding logo" width="100px" height="auto">
                                    </div>
                                    <?php
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" action="<?= base_url('/login/auth') ?>" method="POST" validate>
                                ...
                                <p class="card-subtitle line-on-side text-muted text-center font-small-3 mx-2 my-1"><span>New to TRPL Shop ?</span></p>
                                <div class="card-body">
                                    <a href="/auth/register" class="btn btn-outline-danger btn-block"><i class="ft-user"></i> Register</a>
