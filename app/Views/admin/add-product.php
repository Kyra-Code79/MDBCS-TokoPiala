			...
			<div class="content-header row">
				...
				<div class="content-header-right col-md-6 col-12">
					<div class="btn-group float-md-right">
						<button class="btn btn-info" type="button" aria-haspopup="true" aria-expanded="false" id="addProductBtn">Tambah</button>
					</div>
				</div>
				...
				<div class="modal fade" id="addProductModal" tabindex="-1" role="dialog" aria-labelledby="addProductModalLabel" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<form id="addProductForm" action="<?= base_url('/admin-product/add') ?>" method="POST" enctype="multipart/form-data">
								<div class="modal-body">
									...
									<div class="form-group">
										...
										<textarea class="form-control" name="stok" id="stok" rows="3" required></textarea>
									</div>
									<div class="form-group">
