...
<body class="vertical-layout vertical-menu-modern 2-columns  product-detail-page menu-expanded fixed-navbar"
            ...
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row position-relative">
                    ...
                    <li class="nav-item mr-auto"><a class="navbar-brand" href="/"><img class="brand-logo"
                            ...
                            <h3 class="brand-text">TRPL SHOP</h3>
                        </a></li>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active"><a href="/"><i class="la la-th-large"></i><span class="menu-title"
                            data-i18n="">Shop</span></a>
                </li>
                <li class=" nav-item"><a href="/auth/login"><i class="la la-shopping-cart"></i><span class="menu-title"
                            data-i18n="">Shopping Cart</span></a>
                </li>
                <li class=" nav-item"><a href="/auth/login"><i class="la la-credit-card"></i><span class="menu-title"
                            data-i18n="">Checkout</span></a>
                </li>
                <li class=" nav-item"><a href="/auth/login"><i class="la la-check-circle-o"></i><span class="menu-title"
                            data-i18n="">Order</span></a>
                </li>
                <li class=" nav-item"><a href="#"><i class="la la-clipboard"></i><span class="menu-title"
                            data-i18n="nav.invoice.main">Invoice</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="/auth/login" data-i18n="nav.invoice.invoice_template">Invoice
                                Template</a>
                        </li>
                        <li><a class="menu-item" href="/auth/login" data-i18n="nav.invoice.invoice_list">Invoice
                                List</a>
                        </li>
                    </ul>
                </li>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="product-img d-flex align-items-center">
                                            ...
                                            <img class="img-fluid mb-1"
                                                src="<?= base_url('app-assets/images/elements/fitbit-watch.png') ?>"
                                                alt="Default image">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="col-8">
                                        <div class="title-area clearfix">
                                            <h2 class="product-title float-left"><?= esc($product['nama_produk']) ?>
                                            </h2>
                                            <span class="ratings float-right"></span>
                                        </div>
                                        <div class="price-reviews clearfix">
                                            <span class="price-box">
                                                <span class="price h4">Rp <?= esc($product['harga']) ?></span>
                                                <!-- <span class="old-price h4">$500</span> Example old price -->
                                            </span>
                                        ...
                                        <!-- Color Options (Example colors, adjust as needed) -->
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="product-options color-options mb-2">
                                                    <ul>
                                                        <li><span class="option-title">Color : </span></li>
                                                        <li><a href="#"><span class="color-info black"></span></a></li>
                                                        <li><a href="#"><span class="color-info amber"></span></a></li>
                                                        <li><a href="#"><span class="color-info teal"></span></a></li>
                                                        <li><a href="#"><span class="color-info active red"></span></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-3 col-lg-3 col-md-6 mb-1">
                                                <div class="product-count pr-1">
                                                    <div class="input-group">
                                                        <input type="text" class="text-center count touchspin"
                                                            value="1" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-5 col-lg-5 col-md-12">
                                                <div class="product-buttons pl-2">
                                                    <a href="/auth/login" class="btn btn-danger btn-sm"><i
                                                            class="la la-shopping-cart"></i> Add to Cart</a>
                                                    <a href="/auth/login" class="btn btn-info btn-sm"><i
                                                            class="la la-flash"></i> Buy Now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <ul class="product-tabs nav nav-tabs nav-underline no-hover-bg">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="description" data-toggle="tab"
                                                aria-controls="desc" href="#desc" aria-expanded="true">Description</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="review" data-toggle="tab" aria-controls="ratings"
                                                href="#ratings" aria-expanded="false">Ratings</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="comments" data-toggle="tab" aria-controls="comment"
                                                href="#comment" aria-expanded="false">Comments</a>
                                        </li>
                                    </ul>
                                    <div class="product-content tab-content px-1 pt-1">
                                        <div role="tabpanel" class="tab-pane active" id="desc" aria-expanded="true"
                                            ...
                                            <!-- Product Name -->
                                            <h2 class="my-1"><?= esc($product['nama_produk']) ?></h2>

                                            <!-- Product Description -->
                                            <p><?= esc($product['deskripsi_produk']) ?></p>

                                            <!-- Product Price -->
                                            <div class="price">Price: Rp. <?= esc($product['harga']) ?></div>

                                            <!-- Special Features (Example) -->
                                            <h4>Special Features:</h4>
                                            <ul>
                                                <li>Feature 1 for <?= esc($product['nama_produk']) ?></li>
                                                <li>Feature 2 for <?= esc($product['nama_produk']) ?></li>
