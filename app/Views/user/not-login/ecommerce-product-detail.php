...
<head>
  ...
  <title>Product Detail - Modern Admin - Clean Bootstrap 4 Dashboard HTML Template + Bitcoin Dashboard</title>
...
<body class="vertical-layout vertical-menu-modern 2-columns  product-detail-page menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
  ...
  <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="/"><i class="la la-th-large"></i><span class="menu-title" data-i18n="">Shop</span></a>
        </li>
                ...
                <div class="row">
                  ...
                  <div class="col-8">
                    <div class="title-area clearfix">
                      <h2 class="product-title float-left">Fitbit Alta HR Special Edition</h2>
                      <span class="ratings float-right"></span>
                    </div>
                    <div class="price-reviews clearfix">
                      <span class="price-box">
                        <span class="price h4">$250</span>
                    ...
                    <div class="product-info">
                      <p>Chocolate cake croissant lollipop danish macaroon. Gummies candy jelly-o chocolate tart jelly-o sesame snaps
                        jelly-o. Muffin cake dessert biscuit. Chupa chups jelly beans powder chocolate cake lollipop cake donut toffee
                        sugar plum. Sweet roll liquorice halvah cupcake chocolate apple pie cheesecake pastry wafer. Cheesecake cupcake
                        sugar plum apple pie.</p>
                      <p>Cotton candy bonbon halvah. Caramels sesame snaps sweet roll tart gummi bears. Lollipop cake chocolate bar
                        chupa chups jujubes fruitcake. Croissant powder dessert toffee icing carrot cake icing croissant.Sweet brownie
                        halvah topping chocolate. Macaroon lemon drops sugar plum cupcake cheesecake bear claw. Macaroon jujubes oat
                        cake chupa chups dessert jelly beans. Biscuit lemon drops cupcake powder.</p>
                      <p>Croissant powder dessert toffee icing carrot cake icing croissant.Sweet brownie halvah topping chocolate.
                        Macaroon lemon drops sugar plum cupcake cheesecake bear claw. Macaroon jujubes oat cake chupa chups dessert
                        jelly beans.</p>
                    </div>
                      ...
                      <div class="col-lg-6">
                        <div class="product-options color-options mb-2">
                          <ul>
                            ...
                            <li>
                              <a href="#">
                                <span class="color-info active red"></span>
                              </a>
                            </li>
                          </ul>
                        </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xl-5 col-lg-5 col-md-12">
                        <div class="product-buttons pl-2">
                          <a href="login" class="btn btn-danger btn-sm"><i class="la la-shopping-cart"></i> Add
                            to Cart</a>
                          <a href="login" class="btn btn-info btn-sm"><i class="la la-flash"></i> Buy Now</a>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card-content">
                <div class="card-body">
                  <ul class="product-tabs nav nav-tabs nav-underline no-hover-bg">
                    <li class="nav-item">
                      <a class="nav-link active" id="description" data-toggle="tab" aria-controls="desc" href="#desc" aria-expanded="true">Description</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="review" data-toggle="tab" aria-controls="ratings" href="#ratings" aria-expanded="false">Ratings</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="comments" data-toggle="tab" aria-controls="comment" href="#comment" aria-expanded="false">Comments</a>
                    </li>
                  </ul>
                  <div class="product-content tab-content px-1 pt-1">
                    <div role="tabpanel" class="tab-pane active" id="desc" aria-expanded="true" aria-labelledby="description">
                      <h2 class="my-1">Fitbit Alta HR Special Edition</h2>
                      <p>Tootsie roll gingerbread dragée gummies candy tart. Danish dessert sweet roll icing dessert bonbon. Brownie
                        sesame snaps pastry chocolate biscuit wafer tart. Candy canes gummies wafer donut chupa chups pudding sweet
                        donut. Lollipop halvah dessert chocolate cake danish cake. Oat cake topping sweet chocolate muffin cake pie
                        halvah. Topping danish fruitcake apple pie carrot cake. Pudding cupcake cupcake cotton candy croissant. Pastry
                        pastry jelly beans powder dragée toffee wafer cupcake pastry. Sweet lemon drops lollipop croissant bonbon.
                        Soufflé biscuit dessert biscuit gummi bears sugar plum cake. Tootsie roll sugar plum bear claw chocolate bar
                        gummies pudding powder danish caramels. Bear claw biscuit lemon drops croissant gummi bears. Lollipop chupa
                        chups soufflé sweet roll soufflé biscuit bear claw wafer.</p>
                      <p>Liquorice candy cotton candy tootsie roll chupa chups jelly-o pastry croissant marshmallow. Gingerbread
                        tiramisu jelly. Cheesecake pudding marshmallow marshmallow candy donut donut chocolate cake gummies. Macaroon
                        tootsie roll wafer ice cream. Icing cupcake pudding. Caramels topping cake caramels toffee sesame snaps pie
                        halvah halvah. Sesame snaps toffee pudding macaroon soufflé sesame snaps. Topping lemon drops sweet roll
                        lollipop chocolate bar soufflé cotton candy carrot cake. Lollipop dragée cheesecake toffee donut macaroon tart
                        marshmallow. Croissant jelly-o chocolate jujubes soufflé. Halvah sweet pastry apple pie cake. Powder icing
                        bonbon candy canes. Cake toffee marshmallow chocolate cake candy canes.</p>
                      <p>Caramels macaroon lemon drops topping topping. Jelly muffin muffin sweet roll dragée gummi bears cake wafer
                        apple pie. Pudding gingerbread oat cake. Jelly chocolate bar candy. Cotton candy macaroon jelly beans caramels
                        sesame snaps chocolate caramels cheesecake icing. Oat cake chocolate cake halvah gingerbread. Icing candy
                        marzipan. Powder dessert marzipan powder. Candy canes cake croissant jelly beans chupa chups chocolate cake.
                        Jelly-o candy toffee caramels jelly-o marshmallow. Lollipop wafer caramels pudding. Icing gingerbread halvah
                        chocolate bar caramels.</p>
                      <p>Pudding tootsie roll lollipop tiramisu chocolate oat cake carrot cake sweet roll powder. Powder gingerbread
                        pie biscuit candy pie cookie toffee icing. Muffin muffin chocolate. Tiramisu ice cream jelly beans jelly-o
                        ...
                        chocolate bar biscuit tootsie roll candy chocolate bar. Lemon drops halvah pastry. Tart donut halvah pudding.
                        Caramels gummies caramels candy.</p>
                      <br>
                      <h4>Special Features : </h4>
                      <ul>
                        <li>Jelly-o candy toffee caramels jelly-o marshmallow.</li>
                        <li>Cotton candy jujubes cupcake.</li>
                        <li>Donut cake pie.</li>
                        <li>Dessert liquorice gummi bears.</li>
                        <li>Lemon drops halvah pastry.</li>
                      </ul>
                    </div>
                    <div class="tab-pane" id="ratings" aria-labelledby="review">
                      ...
                      <div class="media-list media-bordered">
                        <div class="media">
                          <span class="media-left">
                            <img class="media-object" src="../../../app-assets/images/portrait/small/avatar-s-1.png" alt="Generic placeholder image"
                          ...
                          <div class="media-body">
                            ...
                            Tootsie roll chocolate cake oat cake. Cake topping sweet jelly beans gummies. Oat cake sugar plum cheesecake
                            dragée bear claw chocolate cake dessert gummies chupa chups. Jujubes cake cotton candy danish gingerbread
                            pastry tart danish tart. Gummies croissant icing tart. Sweet muffin marzipan danish. Lemon drops carrot cake
                            carrot cake gummies. Oat cake wafer dessert. Chocolate jujubes jelly biscuit. Soufflé sweet cheesecake.
                          </div>
                        </div>
                        <div class="media">
                          <span class="media-left">
                            <img class="media-object" src="../../../app-assets/images/portrait/small/avatar-s-8.png" alt="Generic placeholder image"
                              style="width: 64px;height: 64px;" />
                          </span>
                          <div class="media-body">
                            <span class="ratings float-right"></span>
                        ...
                        <div class="media">
                          <span class="media-left">
                            <img class="media-object" src="../../../app-assets/images/portrait/small/avatar-s-6.png" alt="Generic placeholder image"
                              style="width: 64px;height: 64px;" />
                          </span>
                          <div class="media-body">
                            <span class="ratings float-right"></span>
                            ...
                            Cookie lollipop caramels. Liquorice jelly beans icing chupa chups. Wafer brownie fruitcake sugar plum
                            tiramisu. Jelly bear claw biscuit pie wafer. Croissant chupa chups cake. Tart dessert gingerbread cupcake.
                            Ice
                            cream jelly-o bonbon pudding chupa chups danish topping topping. Candy canes pastry wafer cheesecake
                            brownie.
                            Croissant donut bonbon candy sesame snaps candy canes sesame snaps wafer. Muffin candy croissant biscuit
                            dragée.
                          </div>
                        </div>
                      </div>
                      ...
                      <form class="form">
                        <div class="form-body">
                          <label>Ratings</label>
                          <div id="customer-review" class="mb-1"></div>
                          <div class="row">
                            <div class="col-md-6">
                    ...
                    <div class="tab-pane" id="comment" aria-labelledby="comments">
                      ...
                      <div class="media-list media-bordered">
                        <div class="media">
                          <span class="media-left">
                            <img class="media-object" src="../../../app-assets/images/portrait/small/avatar-s-10.png" alt="Generic placeholder image"
                              style="width: 64px;height: 64px;" />
                          </span>
                          <div class="media-body">
                            <h5 class="media-heading mb-0 text-bold-600">
                            ...
                            Cupcake ice cream cake cotton candy gummi bears cotton candy macaroon chocolate. Cake croissant tiramisu
                            dragée marshmallow halvah tiramisu. Gummi bears soufflé pudding. Donut muffin brownie brownie. Liquorice
                            sweet
                            roll chocolate cake tootsie roll fruitcake. Jujubes bonbon cake chocolate bar liquorice pastry dessert.
                            Fruitcake apple pie pie caramels sweet roll. Jelly icing jujubes soufflé.
                          </div>
                        </div>
                        <div class="media">
                          <span class="media-left">
                            <img class="media-object" src="../../../app-assets/images/portrait/small/avatar-s-12.png" alt="Generic placeholder image"
                              style="width: 64px;height: 64px;" />
                          </span>
                          <div class="media-body">
                            <h5 class="media-heading mb-0 text-bold-600">
                            ...
                            Brownie cotton candy topping chocolate cake danish dragée soufflé jujubes powder. Toffee tart carrot cake
                            donut. Macaroon apple pie sweet roll sweet toffee sweet. Pastry powder croissant candy canes jelly beans
                            macaroon macaroon donut. Jelly beans ice cream marshmallow. Tiramisu cupcake pudding sesame snaps. Jelly-o
                            caramels gummies candy canes apple pie chupa chups jelly macaroon sweet roll.
                          </div>
                        </div>
                        <div class="media">
                          <span class="media-left">
                            <img class="media-object" src="../../../app-assets/images/portrait/small/avatar-s-7.png" alt="Generic placeholder image"
                              style="width: 64px;height: 64px;" />
                          </span>
                          <div class="media-body">
                            <h5 class="media-heading mb-0 text-bold-600">
                            ...
                            Jelly dragée pie carrot cake caramels marshmallow. Wafer croissant wafer cookie liquorice. Candy canes
                            soufflé
                            brownie jelly macaroon wafer gummies cotton candy danish. Soufflé sweet carrot cake halvah liquorice
                            jujubes.
                            Sweet chocolate carrot cake. Liquorice donut biscuit soufflé. Brownie sweet roll dragée apple pie soufflé
                            cheesecake. Biscuit jelly carrot cake danish pudding dessert biscuit cake fruitcake. Jelly toffee cotton
                            candy
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" id="pr-name" class="form-control" placeholder="Name" name="name">
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                <label for="pr-subject">Subject</label>
                                <input type="text" id="pr-subject" class="form-control" placeholder="Subject" name="lname">
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="review-desc-comment">Your Comment</label>
                            <textarea id="review-desc-comment" rows="5" class="form-control" name="comment" placeholder="Your Comment"></textarea>
                          </div>
                          <button type="submit" class="btn btn-info">
