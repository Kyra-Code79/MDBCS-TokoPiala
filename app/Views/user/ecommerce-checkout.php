...
<head>
	...
	<title>Checkout - Modern Admin - Clean Bootstrap 4 Dashboard HTML Template + Bitcoin Dashboard</title>
		...
		<div class="navbar-wrapper">
			<div class="navbar-header">
				<ul class="nav navbar-nav flex-row position-relative">
					...
					<li class="nav-item mr-auto"><a class="navbar-brand" href="index.html"><img class="brand-logo" alt="modern admin logo" src="../../../app-assets/images/ico/TRPL.png">
	...
	<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
		<div class="main-menu-content">
			<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
				...
				<li class=" nav-item"><a href="shopping-cart"><i class="la la-shopping-cart"></i><span class="menu-title" data-i18n="">Shopping Cart</span></a>
				</li>
				<li class="active"><a href="checkout"><i class="la la-credit-card"></i><span class="menu-title" data-i18n="">Checkout</span></a>
				</li>
			...
			<div class="content-body">
				<div class="shopping-cart">
					<ul class="nav nav-tabs nav-justified">
						<li class="nav-item">
							<a class="nav-link" id="shopping-cart" data-toggle="tab" aria-controls="shop-cart-tab" href="#shop-cart-tab" aria-expanded="false">Shopping Cart</a>
						</li>
						<li class="nav-item">
							<a class="nav-link active" id="checkout" data-toggle="tab" aria-controls="checkout-tab" href="#checkout-tab" aria-expanded="true">Checkout</a>
						</li>
						<li class="nav-item">
