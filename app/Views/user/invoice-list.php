			...
			<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
				...
				<li class=" nav-item"><a href="#"><i class="la la-clipboard"></i><span class="menu-title" data-i18n="nav.invoice.main">Invoice</span></a>
					<ul class="menu-content">
						<li><a class="menu-item" href="invoiceTemplate" data-i18n="nav.invoice.invoice_template">Invoice Template</a>
						</li>
						<li class="active"><a class="menu-item" href="invoiceList" data-i18n="nav.invoice.invoice_list">Invoice List</a>
						</li>
					</ul>
				</li>
			</ul>
										...
										<table id="invoices-list" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle">
											...
											<tbody>
												...
												<tr>
													...
													<td><span class="badge badge-default badge-success badge-lg">Paid</span></td>
													<td>10/05/2017</td>
													<td>$ 1200.00</td>
													<td>$ 200.00</td>
													<td>
												...
												<tr>
													...
													<td>PO-008941</td>
													<td>Doris Reyes</td>
													<td><span class="badge badge-default badge-warning badge-lg">Overdue By 1-15 Days</span></td>
													<td>11/12/2017</td>
													<td>$ 5685.00</td>
													<td>$ 450.00</td>
													<td>
												...
												<tr>
													...
													<td>PO-005201</td>
													<td>Elizabeth Washington</td>
													<td><span class="badge badge-default badge-warning badge-lg">Overdue By 16-30 Days</span></td>
													<td>06/05/201</td>
													<td>$ 1200.00</td>
													<td>$ 200.00</td>
													<td>
												...
												<tr>
													...
													<td>PO-005201</td>
													<td>Elizabeth Washington</td>
													<td><span class="badge badge-default badge-danger badge-lg">Overdue By 31-45 Days</span></td>
													<td>06/05/201</td>
													<td>$ 1200.00</td>
													<td>$ 200.00</td>
													<td>
												...
												<tr>
													...
													<td>PO-005201</td>
													<td>Elizabeth Washington</td>
													<td><span class="badge badge-default badge-danger badge-lg">Overdue By 45+ Days</span></td>
													<td>06/05/201</td>
													<td>$ 1200.00</td>
													<td>$ 200.00</td>
													<td>
