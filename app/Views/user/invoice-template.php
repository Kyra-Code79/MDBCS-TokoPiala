...
<head>
  ...
  <title>TRPL - Shop | Invoice Template </title>
  ...
  <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" nav-item"><a href="invoiceTemplate"><i class="la la-clipboard"></i><span class="menu-title" data-i18n="nav.invoice.main">Invoice</span></a>
          <ul class="menu-content">
            <li class="active"><a class="menu-item" href="invoiceTemplate" data-i18n="nav.invoice.invoice_template">Invoice Template</a>
            </li>
            <li><a class="menu-item" href="invoiceList" data-i18n="nav.invoice.invoice_list">Invoice List</a>
            </li>
          </ul>
        </li>
      </ul>
          ...
          <div id="invoice-template" class="card-body">
            ...
            <div id="invoice-company-details" class="row">
              <div class="col-md-6 col-sm-12 text-center text-md-left">
                <div class="media">
                  <img src="../../../app-assets/images/ico/TRPL.png" alt="company logo" class="" width="100px" height="auto" />
                  <div class="media-body">
