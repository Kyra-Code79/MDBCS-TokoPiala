	...
	<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
		<div class="main-menu-content">
			<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
				...
				<li class="active"><a href="ecommerce-order.html"><i class="la la-check-circle-o"></i><span class="menu-title" data-i18n="">Order</span></a>
				</li>
			...
			<div class="content-body">
				<div class="shopping-cart">
					<ul class="nav nav-tabs nav-justified">
						...
						<li class="nav-item">
							<a class="nav-link active" id="complete-order" data-toggle="tab" aria-controls="comp-order-tab" href="#comp-order-tab" aria-expanded="true">Complete Order</a>
						</li>
					</ul>
